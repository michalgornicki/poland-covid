...
function App() {
  const startTime = () => {
    ...
    document.getElementsByClassName("counter-3")[0].innerHTML =
      ...
      document.getElementsByClassName("counter-3")[0].innerHTML =
      "Według danych raportu Health at Glance liczba nadmiarowych zgonów w Polsce względem lat ubiegłych wskazuje na to, że liczba ofiar Covid-19 jest wyższa o 85%. Nieoficjalna ale pełna liczba zgonów związanych z epidemią" + (deaths + 28556) + " osób.";
