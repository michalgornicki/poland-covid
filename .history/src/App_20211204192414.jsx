...
function App() {
  ...
  const startTime = () => {
    ...
    document.getElementsByClassName('counter-2')[0].innerHTML = "Łącznie na Covid-19 zginęło w Polsce już" + (deaths + 28556) + osób";
    document.getElementsByClassName('counter-2')[1].innerHTML = deathsPerMillion + "/mln mieszkańców";
  ...
  return (
    <p>
      ...
      <div className="header-2">(W zeszłym roku w Polsce na koronawirusa zginęło 28556 osób.)</div>
